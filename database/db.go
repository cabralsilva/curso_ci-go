...
func ConectaComBancoDeDados() {
	stringDeConexao := "host=" + os.Getenv("DATABASE_URL") + " user=" + os.Getenv("DATABASE_USER") + " password=" + os.Getenv("DATABASE_PWD") + " dbname=" + os.Getenv("DATABASE_DBNAME") + " port=" + os.Getenv("DATABASE_DBPORT") + " sslmode=disable"
